...
class Player {
    ...
    constructor(_id: number, _sex: boolean) {
        ...
        let range: Range = PLAYERS_LIST.getRange(3, 3, PLAYERS_LIST.getLastRow() - 2, 1);
        ...
        let rowData: any[] = PLAYERS_LIST.getRange(this._rowIndex, 2, 1, PLAYERS_LIST.getLastColumn() - 1).getValues()[0];
    ...
    public activate(): void {
        PLAYERS_LIST.getRange(this._rowIndex, 2).activate();
    }
    ...
    private updateItems(rowData?: any[]): Item[] {
        if (rowData === undefined) {
            rowData = PLAYERS_LIST.getRange(this._rowIndex, 2, 1, PLAYERS_LIST.getLastColumn() - 3).getValues()[0];
        }
        ...
        let header: any[] = PLAYERS_LIST.getRange(1, 2, 1, PLAYERS_LIST.getLastColumn() - 3).getValues()[0];
