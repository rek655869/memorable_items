...
const copyReadmeEntry = './README.js';
const devServerWrapper = './dev/dev-server-wrapper.html';

const clientEntrypoints = [
  {
    name: 'CLIENT - Checking Players Dialog',
    filename: 'checking-dialog',
    template: 'checking-dialog/index.html',
  },
  {
    name: 'CLIENT - Search Sidebar',
    filename: 'search-sidebar',
    template: 'search-sidebar/index.html',
  },
  {
    name: 'CLIENT - Delete Players Sidebar',
    filename: 'delete-players-sidebar',
    template: 'delete-players-sidebar/index.html',
  },
];
